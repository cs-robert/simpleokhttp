package com.robert.okhttputil.cookie;
 ...
 * okhttp3cooke存储
 */
public class Okhttp3PersistentCookieStore {
     ...
     */
    public Okhttp3PersistentCookieStore(Context context) {
    ...
    public void add(URI uri, Cookie cookie) {
        ...
        prefsWriter.putString(COOKIE_NAME_PREFIX + cookie.name(), encodeCookie(new Okhttp3SerializableHttpCookie(cookie)));
        prefsWriter.commit();
    }
     ...
     */
    protected String encodeCookie(Okhttp3SerializableHttpCookie cookie) {
        if (cookie == null)
            return null;
    ...
    protected Cookie decodeCookie(String cookieString) {
        ...
        try {
            ...
            cookie = ((Okhttp3SerializableHttpCookie) objectInputStream.readObject()).getCookie();
        } catch (IOException e) {
